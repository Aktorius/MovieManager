...
public class Movie implements Serializable{
    ...
    private String backtropPath;

    public Movie(String id, String title, String overview, float voteAverage, float voteCount, String posterPath, String backtropPath) {
        this.id = id;
        this.title = title;
        ...
        this.backtropPath = backtropPath;
    }
